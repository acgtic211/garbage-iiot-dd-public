<script>
    ...
    function watchRoute(){
        ...
        /*if(data.onRoute){
            ...
            alert('There is no active route at the moment.');
        }*/
    }
    ...
    <div class="card">
        <div class="grd">
            ...
            <div class="funcs">
                ...
                <button class="tbtn" on:click={watchRoute}>Watch route</button>
            </div>
            <div class="map">
                <Route routeID={data.actualRoute}/>
            </div>
        </div>
    </div>
</div>
...
<style>
   .fragment{
    ...
    .grd{
        display: grid;
        grid-template-areas: 'data btn map map map map map map map map';
        height: 500px;
    }
